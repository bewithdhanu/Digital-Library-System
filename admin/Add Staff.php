				...
				?>
					<table width="100%" border="1" align="center">
									<tr>
										...
										<td width="25%"><input name="uid" type="text"
											autofocus="autofocus" required maxlength="10" /></td>
									...
									<tr>
										...
										<td><input type="password" name="pwd1" required maxlength="10" /></td>
									...
									<tr>
										<td colspan="4"><input type="checkbox" name="tnc" id="tnc"
											required="required" /> <label for="tnc">I will handle the
												book carefully. If any damage is done to the book, I will
												replace it with a new copy of same. In case of loss of
												books, I will pay amount as applicable</label></td>
									</tr>
									<tr>
										<td colspan="4" align="center"><input type="submit"
											id="submit" value="Submit" /> <input type="reset" /></td>
									</tr>
								</table>
							</form>
						</td>
